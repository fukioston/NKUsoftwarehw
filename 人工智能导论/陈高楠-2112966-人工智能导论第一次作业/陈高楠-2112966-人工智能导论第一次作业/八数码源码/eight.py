...
all_start = [
    ...
    [[4, 1, 2], [5, 0, 3], [7, 8, 6]],  # 6
    [[1, 2, 3], [7, 0, 4], [5, 8, 6]],  # 8
    [[4, 5, 1], [2, 0, 3], [7, 8, 6]],  # 10
    [[2, 7, 3], [1, 0, 4], [8, 6, 5]],  # 12
    [[5, 1, 6], [4, 3, 8], [0, 2, 7]],  # 14
    [[5, 1, 6], [4, 0, 8], [2, 3, 7]],  # 16
    [[5, 6, 0], [4, 1, 8], [2, 3, 7]],  # 18
    [[0, 1, 2], [3, 5, 4], [7, 6, 8]],  # 20
    [[0, 1, 2], [3, 4, 7], [5, 6, 8]],  # 22
    [[0, 1, 2], [3, 4, 7], [6, 8, 5]],  # 24

]
d = 2
for result in all_start:
    DFS = 0.0
    BFS = 0.0
    IDDFS = 0.0
    A1 = 0.0
    ...
    d += 2
    for i in range(5):
        DFS += test_DFS(result, 25)
        DFS2 += test_DFS(result, 50)
        DFS3 += test_DFS(result, 75)
        DFS4 += test_DFS(result, 100)
        BFS += test_BFS(result)
        IDDFS += test_IDDFS(result)
        A1 += test_A1(result)
        A2 += test_A2(result)
        A3 += test_A3(result)
        A4 += test_A4(result)
        greedy += test_Greedy(result)
        best += test_best(result)
    DFS /= 5
    BFS /= 5
    IDDFS /= 5
    A1 /= 5
    ...
    best /= 5
    greedy /= 5
    print("DFS平均运行时间：" + str(DFS))
    print("DFS2平均运行时间：" + str(DFS2))
    print("DFS3平均运行时间：" + str(DFS3))
    print("DFS4平均运行时间：" + str(DFS4))
    print("BFS平均运行时间：" + str(BFS))
    print("IDDFS平均运行时间：" + str(IDDFS))
    print("greedy平均运行时间：" + str(greedy))
    print("best平均运行时间：" + str(best))
    print("A1平均运行时间：" + str(A1))
    print("A2平均运行时间：" + str(A2))
    print("A3平均运行时间：" + str(A3))
    print("A4平均运行时间：" + str(A4))
